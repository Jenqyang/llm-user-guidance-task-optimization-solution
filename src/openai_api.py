...
MODEL_PATH = os.environ.get('MODEL_PATH', 'THUDM/cogagent-vqa-hf')
...
async def list_models():
    ...
    """
    model_card = ModelCard(id="cogagent-vqa-18b")  # can be replaced by your model id like cogagent-chat-18b
